...
const NewMan = () => {
  ...
  return (
    <div className='w-full h-full flex flex-col gap-4 text-[16px]'>
      <h2 className="text-[25px] text-slate-600 font-semibold">Ajouter un Nouveau Manager</h2>
      <form action="" onSubmit={handleSubmit} className='flex flex-col gap-4'>
        <div className="w-full flex flex-col justify-between items-start gap-2 p-1 border border-slate-50 py-4">
            <h4 className='text-orange-500 font-bold text-[15px]'>Identité</h4>
            <div className="w-full flex gap-2">
                <input type="text" placeholder="Nom du Manager Outsourcing" className='w-1/2 border h-10 p-1 rounded-sm outline-none'/>
        ...
        <div className="w-full flex flex-col justify-between items-center gap-2 p-1 py-4">
                <button className=' w-80 h-12 bg-slate-600 text-white font-bold rounded-md hover:bg-orange-600 transition:ease-in-out duration-100'>Bonjour le monde</button>
        </div>
      </form>
    </div>
  )
